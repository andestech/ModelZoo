...
# ref: https://github.com/lukemelas/EfficientNet-PyTorch/blob/master/examples/imagenet/main.py
...
def return_dataset():
    ...
    )  # extract specific calibration subset for quantiztation
