...
## Model infomation
This folder provides the code needed to reproduce the Inception-v2 image classification model described in the [Going deeper with convolutions](https://arxiv.org/abs/1409.4842) paper.

| Name | Task | Source | FP32 | W8A8 |
| ---- | ---- | ---- | ---- | ---- |
| Inception-v2 | Image Classification | https://www.kaggle.com/models/google/inception-v2/ | Model/Inception_v2_fp32.onnx | Model/model.tflite |

| Precision Mode | Format | Metric (Acc) | NN SDK Version |
| ---- | ---- | ---- | ---- |
| FP32 | ONNX (opset_v13) | 73.446 | N/A |
| W8A8 | TFLite v2.17.0 | 73.252 | v1.1.1 |
