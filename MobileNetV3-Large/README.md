...
## Model infomation
This folder provides the code needed to reproduce the MobileNetV3 image classification model from torchvision.

| Name | Task | Source | FP32 | W8A8 |
| ---- | ---- | ---- | ---- | ---- |
| MobileNetV3-Large | Image Classification | https://docs.pytorch.org/vision/stable/models/generated/torchvision.models.mobilenet_v3_large.html | https://download.pytorch.org/models/mobilenet_v3_large-8738ca79.pth | Model/model.tflite |

| Precision Mode | Format | Metric (Acc) | NN SDK Version |
| ---- | ---- | ---- | ---- |
| FP32 | Torch module | 74.04 | N/A |
| W8A8 | TFLite v2.17.0 | 72.582 | v1.2.0 |
