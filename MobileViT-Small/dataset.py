...
def return_dataset():
    tra_dataset = datasets.ImageFolder(
        ...
        transforms.Compose(
            [
                transforms.RandomResizedCrop(256, scale=(0.08, 1.0), interpolation=transforms.InterpolationMode.BILINEAR),
    ...
    cos_dataloader = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=6, pin_memory=False, prefetch_factor=5)
