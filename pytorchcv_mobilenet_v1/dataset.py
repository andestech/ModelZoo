...
def return_dataset():
    ...
    """
    tra_dataloader = DataLoader(tra_dataset, batch_size=input_yaml["batch_size"], shuffle=True, num_workers=6, pin_memory=True, prefetch_factor=5)
    val_dataloader = DataLoader(val_dataset, batch_size=input_yaml["batch_size"], shuffle=False, num_workers=6, pin_memory=True, prefetch_factor=5)
    cal_dataloader = DataLoader(cal_dataset, batch_size=input_yaml["batch_size"], shuffle=False, num_workers=6, pin_memory=True, prefetch_factor=5)
    cos_dataloader = DataLoader(cos_dataset, batch_size=1, shuffle=False, num_workers=6, pin_memory=False)
