...
def return_fp32_model():
    # tiny-YOLOv2
    print('Tiny_YOLO_V2')
    model_test = Tiny_YOLOv2("model_ws_package/tiny_yolo_v2_torchvision/yolov2-tiny-voc.cfg")
    load_weights(model_test, "model_ws_package/tiny_yolo_v2_torchvision/yolov2-tiny-voc.weights", version="v2")
